import { createTimeContract } from '../../src/content/timeContract';
...
const fresh = (): State => ({persistent:{loopCount:1,clueIds:[],deductionIds:[],memories:[],deathIntel:[],deathRecords:[],flags:{}},volatile:{time:0 as GameTime,clock:createTimeContract(),currentSceneId:SCENE_CH00_ENTRANCE,currentLocationId:LOCATION_MOUNTAIN_ROAD,visitedSceneIds:[SCENE_CH00_ENTRANCE],itemIds:[],flags:{}}});
...
export function explore(anchorOnly:boolean) {
